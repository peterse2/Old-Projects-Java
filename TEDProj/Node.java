...
public class Node {
	...
	/*******************************************************************
	 * Constructor: Initializes a newly constructed Node object.
	...
	/*******************************************************************
	 * Sets the next node to the node that the current one refers to.
	 * @param next node that this node refers to
	 ******************************************************************/
	 ...
	 * @return data a string representation of the value of this object
	 ******************************************************************/
